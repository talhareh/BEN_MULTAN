...
import { faGraduationCap, faAward, faUsers, faBookOpen, faSchool, faChalkboardTeacher } from '@fortawesome/free-solid-svg-icons';
import Button from '../ui/Button';

const AcademicsHero = () => {
  const whatsappUrl = `https://wa.me/+923708382215?text=Hello! I'd like to know more about your O & A Level academic programs at BEN.`;
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <div className="grid grid-cols-3 gap-6 mb-8">
              <div className="text-center">
                <div className="text-2xl font-bold mb-1 text-white">12+</div>
                <div className="text-sm text-red-200">Subjects Offered</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold mb-1 text-white">90%+</div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button 
                ...
                variant="outline"
                size="lg"
                className="bg-white !text-red-900 border-white hover:bg-red-50 hover:!text-red-900"
              >
                Get Program Details
              </Button>
              <Button 
                href="https://wa.me/+923708382215?text=Hello! I'd like to book a free trial class at BEN."
                variant="outline"
                size="lg"
          ...
          <div className="relative">
            <div className="bg-white rounded-2xl p-4 backdrop-blur-sm">
              <div className="relative rounded-xl h-80 overflow-hidden">
                <Image
                  src="/images/academics/student-with-books.jpg"
                  alt="Student with books giving thumbs up - representing academic success"
                  fill
